...
대칭키 암호화 방식은 동일한 키로 암호화와 복호화가 가능한것임. 상대적으로 성능이 좋고 컴퓨팅 비용도 적음. 같은 키가 사용되는 만큼 보안에 취약하며 대칭 키를 전달하다가 intercept 당하면 문제가 심각해짐. 이런 문제를 해결하기 위해 나온게 공개키 방식임. [참고](https://www.ibm.com/docs/en/ztpf/2023?topic=concepts-symmetric-cryptography)
